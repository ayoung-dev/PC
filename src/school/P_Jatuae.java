...
public class P_Jatuae extends JFrame {
	...
	public P_Jatuae(String id) throws Exception {
		...
		//휴학 신청 확인
        String colNames[] = {"학번", "이름", "학년도", "학기", "신청일", "처리상태"};
        String rows[][] = {};
        ...
        JLabel Title = new JLabel("자퇴 신청 조회");
        Title.setFont(new Font("한컴산뜻돋움", Font.BOLD, 23));
        Title.setBounds(12, 210, 172, 27);
        Main.add(Title);
     	...
     	Delete.addActionListener(new ActionListener() {
  			public void actionPerformed(ActionEvent e) {
  				try {
					...
					pm.deleteDrop(stNum, now);
					model.removeRow(row);
					JOptionPane.showMessageDialog(null,"해당 자퇴 신청이 취소되었습니다.");
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
     	...
     	Confirm.addActionListener(new ActionListener() {
  			public void actionPerformed(ActionEvent e) {
  				try {
  					...
  					String stNum = (String) table.getValueAt(row, 0);
  					String now = (String) table.getValueAt(row, 4);
					pm.acceptDrop(stNum, now);
					JOptionPane.showMessageDialog(null,"해당 자퇴 신청이 승인되었습니다.");
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
