		...
		okBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					try {
						...
						if (pmg.findId(email, phoneNum)!= null) { // 교번을 입력하고 로그인을 시도했을 때

							String prNum = pmg.findId(email, phoneNum);
							JOptionPane.showMessageDialog(null, "교번 : " + prNum, "확인", JOptionPane.INFORMATION_MESSAGE);

						} else if (smg.findId(email, phoneNum)!= null) { // 학번을 입력하고 로그인을 시도했을 때

							String stNum = smg.findId(email, phoneNum);
							JOptionPane.showMessageDialog(null, "학번 : " + stNum, "확인", JOptionPane.INFORMATION_MESSAGE);
						} else 
