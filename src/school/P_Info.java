...
public class P_Info extends JFrame {
	...
	public P_Info(String id) throws Exception {
		...
		//학적 정보 입력
        String colNames[] = {"개설 학년도", "과목명", "학수 번호", "학점", "수강 인원"};
        String rows[][] = {};
        ...
        // 해당 학생 신청 여부 띄우기
     	...
     	if (rs.getRow() > -1) {
     		while (rs.next()) {
     			...
     			//과목 수강인원 받아오기
     			String mem = rs.getString(9);
     			// GUI에 띄우기
     			String[] row = { semester, name, num, credit, mem};
        ...
        ProfSubject.setBounds(12, 210, 172, 27);
